...
{
    //delete the old shapes.txt

    if( remove( "C:/Users/isaac_m2olzwl/OneDrive/Documents/project/shapes.txt" ) != 0 )
    {
    ...
    //transform vector of shapes into a text file
    // (for now just making a file with some random shapes)

    serializeWrite();

    //rename the new text file into shapes.txt

    int result;
    char oldname[] = "C:/Users/isaac_m2olzwl/OneDrive/Documents/project/shapes_copy.txt";
    char newname[] = "C:/Users/isaac_m2olzwl/OneDrive/Documents/project/shapes.txt";
